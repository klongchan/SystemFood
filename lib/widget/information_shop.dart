...
import 'package:systemfood/screens/add_info_shop.dart';
import 'package:systemfood/screens/edit_info_shop.dart';
import 'package:systemfood/screens/edit_info_shop.dart';
...
class _InformationShopState extends State<InformationShop> {
  ...
  Future<Null> readDataUser() async {
    ...
    String url =
        '${MyConstant().domain}/RiwFood/getUserWhereId.php?isAdd=true&id=$id';
    ...
    return <Marker>[
      Marker(
          ...
          infoWindow: InfoWindow(
              title: 'ตำแหน่งร้าน',
              snippet:
                  'ละติจูต = ${userModel.lat}, ลองติจุต = ${userModel.lng}'))
    ].toSet();
  }
