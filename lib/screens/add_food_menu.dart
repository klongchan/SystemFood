...
class _AddFoodMenuState extends State<AddFoodMenu> {
  ...
  Future<Null> uploadFoodAndInsertData() async {
    String urlUpload = '${MyConstant().domain}/RiwFood/saveFood.php';
    ...
    try {
      ...
      await Dio().post(urlUpload, data: formData).then((value) async {
        String urlPathImage = '/RiwFood/Food/$nameFile';
        print('urlPathImage = ${MyConstant().domain}$urlPathImage');

        SharedPreferences preferences = await SharedPreferences.getInstance();
        String idShop = preferences.getString('id');

        String urlInsertData = '${MyConstant().domain}/RiwFood/addFood.php?isAdd=true&idShop=$idShop&NameFood=$nameFood&PathImage=$urlPathImage&Price=$price&Detail=$detail';
