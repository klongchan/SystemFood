...
class _AddInfoShopState extends State<AddInfoShop> {
      ...
      child: RaisedButton.icon(
        ...
        onPressed: () {
          if (nameShop == null ||
            ...
            normalDialog(context, 'กรุณาเลือก รูปภาพ ด้วยค่ะ');
          } else {
            uploadImage();
          }
        },
  ...
  Future<Null> uploadImage() async {
    ...
    String url = '${MyConstant().domain}/RiwFood/saveshop.php';
    ...
    try {
      ...
      await Dio().post(url, data: formData).then((value) {
        ...
        urlImage = '/RiwFood/shop/$nameImage';
  ...
  Future<Null> editUserShop() async {
    ...
    String url =
        '${MyConstant().domain}/RiwFood/editUserWhereid.php?isAdd=true&id=$id&NameShop=$nameShop&Address=$address&Phone=$phone&UrlPicture=$urlImage&Lat=$lat&Lng=$lng';
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        Container(
          width: 250.0,
          child: file == null
              ? Image.asset('images/myimage1.png')
              : Image.file(file),
        ),
        IconButton(
          icon: Icon(
